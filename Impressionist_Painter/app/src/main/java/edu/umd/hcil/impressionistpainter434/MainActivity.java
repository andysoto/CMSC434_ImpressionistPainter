...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuEraser:
                ...
                _impressionistView.setBrushType(BrushType.Eraser);
                return true;
        }
        return false;
    }
    ...
    // Method to save image to phone's gallery
    public void onButtonClickSave (View v) {

        MediaStore.Images.Media.insertImage(getContentResolver(), _impressionistView.retrieveBitmap(), "" , "");
    }
